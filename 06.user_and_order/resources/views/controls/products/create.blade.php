        ...
        <form method="POST" action="{{ route('controls.products.store') }}" enctype="multipart/form-data">
            <div class="px-4 py-5 bg-white space-y-6 sm:p-6">
                ...
                <div class="mb-3">
                    ...
                    <select name="brand_id" id="brand_id" autocomplete="country"  class="country" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
            ...
            <fieldset class="mb-3">
                ...
                <div class="mt-4 space-y-4">
                    ...
                    <input id="push_everything" name="enabled" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" value='1' checked>
                    <label for="push_everything" class="ml-3 block text-sm font-medium text-gray-700">
                        Enable
                    </label>    
                    </div>
                    <div  class="flex items-center">
                    <input id="push_email" name="enabled" type="radio" class="focus:ring-indigo-500 h-4 w-4 text-indigo-600 border-gray-300" value='0'>
